          ...
          <div v-if="!componentLoader" class="price-data">
              <div class="min-price">
                  ...
                  <div class="price-data-base">
                      <MinPriceIcon />
                      <p class="price-data-value"><AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />{{ minPriceLimit | moneyFormat }}</p>
                  </div>
              </div>
              <div class="max-price">
                  ...
                  <div class="price-data-base">
                      <MaxPriceIcon />
                      <p class="price-data-value"> <AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />{{ maxPriceLimit | moneyFormat}}</p>
                  </div>
              </div>
          </div>
              ...
              <div class="">
                          ...
                          <div class="input-wrap-hold w-[90%] flex-grow-1 flex-basis-0">
                              ...
                              <div class="flex flex-row items-center">
                                  <div class="slot-input-currency px-1">
                                      <AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />
                                  </div>
                                  <input
                                      type="number"
                                      step=".01"
                  ...
                  <div class="settlement-breakdown">
                      ...
                      <div class="settlement-breakdown-table">
                                      ...
                                      <div class="data-box min-w-0 relative flex-auto">
                                          ...
                                          <dl class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                                              <div class="absolute top-0 right-0 flex items-center space-x-1">
                                                  <dt class="text-sky-500">
                                                      <span class="sr-only">Value</span>
                                                      <span class="value-span bg-[#575244] rounded-md px-4"><AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />{{ totalSlotPriceCalculated | moneyFormat }}</span>
                                                  </dt>
                                              </div>
                                          </dl>
                                      </div>
                                      ...
                                      <div class="data-box min-w-0 relative flex-auto">
                                          ...
                                          <dl class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                                              <div class="absolute top-0 right-0 flex items-center space-x-1">
                                                  <dt class="text-sky-500">
                                                      <span class="sr-only">Value</span>
                                                      <span class="value-span bg-[#575244] rounded-md px-4">-<AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />{{ feesCalculated | moneyFormat }}</span>
                                                  </dt>
                                              </div>
                                          </dl>
                                      </div>
                                      ...
                                      <div class="data-box min-w-0 relative flex-auto">
                                          ...
                                          <dl class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                                              <div class="absolute top-0 right-0 flex items-center space-x-1">
                                                  <dt class="text-sky-500">
                                                      <span class="sr-only">Value</span>
                                                      <span class="value-span bg-[#575244] rounded-md px-4"><AppCurrencyReaderComponent :currency="slotPriceInputCurrency" />{{ totalSettlementCalculated | moneyFormat }}/month</span>
                                                  </dt>
                                              </div>
                                          </dl>
                                      </div>
                          ...
                          <p v-if="slotPriceInputCurrency === 'USD'" class="settlement-breakdown-warning">NB: You receive your settlements in Naira.</p>
                      </div>
                  </div>
              </div>
...
export default {
  ...
  methods: {
      ...
      initializeSlotPriceLimiters() {
          ...
          const maxPriceLimit = parseFloat(this.currentSubscriptionServiceData.max_price_limit)
      ...
      decreaseSlotPriceSteady() {
          ...
          slotPrice < 0 ? this.slotPrice = "0.00": this.slotPrice = slotPrice.toFixed(2)
