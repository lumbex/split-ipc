<template>
  <div class="app-form-wrapper">
    ...
    <div class="app-form">
      <p class="page-title">What’s Your Email?</p>
      <p class="page-sub">
          The subscription owner will invite you to their subscription.
<!--          The subscription owner will invite you to join their plan via this email.-->
      </p>
      <form action="#" @submit.prevent="submit">
        ...
        <p class="form-group-info">
          You will receive an invite via this email.
        </p>
        ...
        <div class="app-form-base">
          <div @click="checked = !checked" class="custom-checkbox">
            <div class="question text-left">
              I consent to sharing this subscription plan with others.
            </div>
            <div class="indicator">
