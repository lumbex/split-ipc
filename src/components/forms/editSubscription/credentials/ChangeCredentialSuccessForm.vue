  ...
  <div class="app-form-wrapper">
    <div class="app-form">
      <img
        ...
        src="https://res.cloudinary.com/cloud-web-assets/image/upload/v1715174277/splitcash/images/image_2_wofia4.png"
        alt="Action Successful"
      />
      <p class="page-title-sm text-center">New credentials shared</p>
      <p class="text-base text-center text-grey-500 mb-8">
        Your credential has been updated successfully and shared with members of
        your subscription!
      </p>
...
export default {
  name: "ChangeCredentialSuccessForm",
  components: {},
  props: {
