            ...
            <div class="app-form-base">
                <div class="form-info-box">
                    <img
                            ...
                            alt="more info" />
                    <p>Your credentials are verified and securely shared with paying members of your subscription</p>
                </div>
                <button
                    type="submit"
                    class="app-btn light-btn"
                    :disabled="inputError !== '' || subscriptionPassword === '' || subscriptionUsername === '' || confrimSubscriptionPassword === ''"
                >
                    Continue
                </button>
            </div>
...
export default {
  ...
  methods: {
      ...
      isValidPasswordInput() {
          ...
          const condition = this.subscriptionPassword === this.confrimSubscriptionPassword
