  ...
  <div class="app-form-wrapper">
    ...
    <div class="app-form">
      ...
      <p class="text-base text-center text-grey-500 mb-8">
        You’re paid at the end of each month’s usage for keeping the
        subscription active.
      </p>
        ...
        <div class="option intro flex flex-row gap-2 p-2 h-10">
          ...
          <div class="option-text text-white">
            ...
            <span class="text-white font-bold">
              ...
              />{{ hostPotentialSettlement | moneyFormat }}
            </span>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    hostPotentialSettlement() {
      ...
      const daysTillNextBillingDate = this.subscriptionBillingData
        .daysTillNextBillingDate;
