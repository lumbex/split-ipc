          ...
          <div class="troubleshoot-steps">
            <ul>
              <li>
                ...
                <div class="point">
                  <p>
                    Check your email for the invite to join the subscription.
                  </p>
                </div>
              </li>
              <li>
                ...
                <div class="point">
                  <p>Accept the invite and join the subscription.</p>
                </div>
              </li>
              <li>
                ...
                <div class="point">
                  <p>
                    Confirm if you are a member of the subscription from the
                    subscription family page
                  </p>
                </div>
              </li>
              <li>
                ...
                <div class="point">
                  <p>
                    Confirm you are in the same region as the subscription you
                    are joining - if you are not, change your region.
                  </p>
                </div>
              </li>
              <li>
                ...
                <div class="point">
                  <p>Sign out of “Media Purchases” and sign in again.</p>
                </div>
              </li>
              <li>
                ...
                <div class="point">
                  <p>
                    If you are still having issues accessing your subscription,
                    contact support.
                  </p>
                </div>
              </li>
